...
NCORES = 8
RESOLUTION = 'T42', 80  # T42 horizontal resolution, 80 levels in pressure
...
# exp = Experiment('gcm_exp_rrtm_no-ozone_T42_80vert_S0_PIx4', codebase=cb)
exp = Experiment('gcm_exp_rrtm_ozone_comparison_T42_80vert_S0_PIx1', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'mixed_layer_nml': {
        ...
        'albedo_value': 0.35,                  #Albedo value used
        'do_qflux': False,
    },
    ...
    'damping_driver_nml': {
        ...
        'sponge_pbottom':  150.,           #Bottom of the model's sponge down to 50hPa (units are Pa)
        'do_conserve_energy': True,
    },

    'rrtm_radiation_nml': {
        'solr_cnst': 1360.0+3.7*4*0,  #s set solar constant to 1360, rather than default of 1368.22
    ...
    'spectral_dynamics_nml': {
        ...
        'num_levels':80,               #How many model pressure levels to use #80
