...
exp = Experiment('col_lapse_rrtm_co2_h2ox1_S0_gammax9pt8test1', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'rrtm_radiation_nml': {
        'solr_cnst': 1360+0,  #s set solar constant to 1360, rather than default of 1368.22
    ...
    'dry_convection_nml': {
        'gamma': 1*9.8/9.8, #1 sets the nondimensionaled lapse rate to dry adiabat
        'tau':100000
    },
