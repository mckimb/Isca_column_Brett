...
exp = Experiment('ape_soc_testing_2_take2', codebase=cb)
...
# diag.add_field('mixed_layer', 'albedo', time_avg=True) # NOTE: not a diagnostic when albedo is a static field
...
# diag.add_field('atmosphere', 'sphum', time_avg=True) # hus
# diag.add_field('atmosphere', 'ucomp', time_avg=True) # ua
# diag.add_field('atmosphere', 'vcomp', time_avg=True) # va
# diag.add_field('atmosphere', 'temp', time_avg=True)  # ta
# diag.add_field('atmosphere', 'omega', time_avg=True) # wap
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml':{
        ...
        # 'tidaly_locked': False, # NOTE: I'm not sure if I need this option or not
    },
    ...
    'surface_flux_nml':{
        'use_virtual_temp': True, # NOTE: this is True in run_column.py and says to use virtua temperature for BL stability
        'do_simple': True,
        'old_dtaudv': True,
    },
    ...
    'mixed_layer_nml':{
        ...
        'prescribe_initial_dist': True, # NOTE: this if false in run_column.py but I think I'm setting it true here because of _sst
        'evaporation': True,
        'depth': 1e10, # NOTE: I set this to 1e10 in run_column.py, but I don't think I need to do that here because of do_ape_sst
    ...
    'lscale_cond_nml':{
        ...
        'do_evap': False, # don't reevaporate falling precipitation, NOTE: ask Nadir about this one
    },
