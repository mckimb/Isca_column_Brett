...
# exp = Experiment('col_exp_rrtm_ozone_hightop_S0_PIxeigthreal', codebase=cb)
exp = Experiment('col_exp_rrtm_no_ozone_hightop_S0_PIxhalf', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'column_nml': {
        ...
        'num_levels': 99,  # number of levels
        'initial_sphum': 1e-6,
    ...
    'rrtm_radiation_nml': {
        'solr_cnst': 1360-3.7*4*0,  #s set solar constant to 1360, rather than default of 1368.22
...
if __name__=="__main__":
    ...
    #            varname='ozone_1990',
    #            nlevels=99, vcoord_option='uneven_sigma')
