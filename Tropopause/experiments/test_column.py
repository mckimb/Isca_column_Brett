...
RH = 0.7
# lcl_temp=100.
# BL_height= 801 # default is 1200 for my work
ml_depth = float(1e10)
sst = 300.

# exp = Experiment('col_exp_soc_TEST_h2oLWco2_modS0+'+str(S0_add)+'_PIx'+co2_string+'_take39withgorman_decreasing_qstratsat_'+str(ml_depth)+'mdepth_'+str(sst)+'sst', codebase=cb)

# exp = Experiment('col_exp_soc_TEST_h2oLWco2_modS0+'+str(S0_add)+'_PIx'+co2_string+'_take45withgorman_decreasing_qstratsat_'+str(ml_depth)+'mdepth_'+str(sst)+'sst'+'_'+str(BL_height)+'blheight', codebase=cb)

# exp = Experiment('col_exp_soc_TEST_h2oLWco2_modS0+'+str(S0_add)+'_PIx'+co2_string+'_take46withgorman_decreasing_qstratsat_'+str(ml_depth)+'mdepth_'+str(sst)+'sst'+'_'+'blheight_lcl', codebase=cb)

# exp = Experiment('col_exp_'+'LW_h2o_co2_'+str(sst)+'K'+'_PIx'+co2_string+'_take1', codebase=cb)

exp = Experiment('col_testing_4', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        # 'lw_spectral_filename':'/home/links/bam218/Isca/src/atmos_param/spectral_files/arcc/sp_lw_17_dsa_arcc',
        ...
        # 'do_read_ozone': False,
        'dt_rad':7200, # default 3600
        'store_intermediate_rad':True,
        'chunk_size': 1, # default 16
        # 'use_pressure_interp_for_half_levels':False,
        'tidally_locked':False,
        'inc_co2': True, # NOTE: should this be true???
