...
diag.add_field('mixed_layer', 't_surf',   files=['atmos_yearly'], time_avg=True) #ts
...
diag.add_field('mixed_layer', 'albedo',   files=['atmos_yearly'], time_avg=True)

diag.add_field('atmosphere', 'precipitation',     time_avg=True) #pr
diag.add_field('atmosphere', 'condensation_rain', time_avg=True) #pr-pc
diag.add_field('atmosphere', 'rh',                files=['atmos_yearly'], time_avg=True) #hur

#surface wind stress
diag.add_field('atmosphere',   'flux_u', files=['atmos_yearly'], time_avg=True) #tauu - zonal component of stress
diag.add_field('atmosphere',   'flux_v', files=['atmos_yearly'], time_avg=True) #tauv

#near surface properties
diag.add_field('atmosphere',   'temp_2m',                        time_avg=True)
diag.add_field('atmosphere',   'sphum_2m',                       time_avg=True)
diag.add_field('atmosphere',   'u_10m', files=['atmos_yearly'], time_avg=True)
diag.add_field('atmosphere',   'v_10m', files=['atmos_yearly'], time_avg=True)
...
#radiative fluxes
diag.add_field('socrates', 'soc_surf_flux_lw',      files=['atmos_yearly'], time_avg=True) #net
diag.add_field('socrates', 'soc_surf_flux_lw_down', files=['atmos_yearly'], time_avg=True)

diag.add_field('socrates', 'soc_olr',               files=['atmos_yearly'], time_avg=True)

diag.add_field('socrates', 'soc_surf_flux_sw',      files=['atmos_yearly'], time_avg=True) #net
diag.add_field('socrates', 'soc_surf_flux_sw_down', files=['atmos_yearly'], time_avg=True)

diag.add_field('socrates', 'soc_toa_sw',            files=['atmos_yearly'], time_avg=True) #net
diag.add_field('socrates', 'soc_toa_sw_down',       files=['atmos_yearly'], time_avg=True)

#tendencies
diag.add_field('socrates', 'soc_tdt_lw',            files=['atmos_yearly'], time_avg=True)
diag.add_field('socrates', 'soc_tdt_sw',            files=['atmos_yearly'], time_avg=True)
diag.add_field('socrates', 'soc_tdt_rad',           files=['atmos_yearly'], time_avg=True)
...
diag.add_field('dynamics', 'ucomp_vcomp', files=['atmos_yearly'], time_avg=True)
diag.add_field('dynamics', 'sphum_v',     files=['atmos_yearly'], time_avg=True)
diag.add_field('dynamics', 'vcomp_temp',  files=['atmos_yearly'], time_avg=True)
