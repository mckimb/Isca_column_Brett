...
For original script, see https://github.com/ntlewis/Isca/blob/column_model_pr/exp/test_cases/column_test_case/column_test_rrtm_ozone.py
...
# exp = Experiment('column_test_rrtm_no-ozone_17', codebase=cb)
# exp = Experiment('col_exp_rrtm_LCLLZBoutput_TminLCL'+str(lcl_temp)+'_modS0+'+str(S0_add)+'_PIx'+co2_string+'_take121', codebase=cb)
# exp = Experiment('col_exp_rrtm_h2oLWonly_modS0+'+str(S0_add)+'_PIx'+co2_string+'_take6', codebase=cb)
# exp = Experiment('col_exp_rrtm_h2oLWSWonly_modS0+'+str(S0_add)+'_PIx'+co2_string+'_take6', codebase=cb)
exp = Experiment('col_exp_rrtm_h2oLWSWco2_modS0+'+str(S0_add)+'_PIx'+co2_string+'_take6', codebase=cb)
# exp = Experiment('col_exp_rrtm_noh2o_modS0+'+str(S0_add)+'_PIx'+co2_string+'_take1', codebase=cb)
# exp = Experiment('col_exp_rrtm_withSWh2o_modS0+'+str(S0_add)+'_PIx'+co2_string+'_RH'+RH_string, codebase=cb)
# exp = Experiment('col_exp_rrtm_no-ozone_S0_PIxeigth', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'column_nml': {
        ...
        'num_levels': 200,  # number of levels
        'initial_sphum': 1e-6, # default 1e-6
    ...
    'rrtm_radiation_nml': {
        'solr_cnst': 1360.0+S0_add,  #s set solar constant to 1360, rather than default of 1368.22
    ...
    'qe_moist_convection_nml': {
        ...
        'Tmin':lcl_temp, # min temperature for convection scheme look up tables
